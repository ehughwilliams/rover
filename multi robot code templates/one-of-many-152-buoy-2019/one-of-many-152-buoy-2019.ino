/*  BUOY CODE -- IP ADDR 192.168.1.152 PORT 8882 */
...
byte mac[] = {0x90, 0xA2, 0xDA, 0x0F, 0x53, 0xE2}; // MAC ADDR MUST BE UNIQUE FOR MULTI
IPAddress gateway(192, 168, 1, 1);
IPAddress subnet(255, 255, 255, 0);
IPAddress ip(192, 168, 1, 152);
unsigned int localPort = 8882;      // local port to listen on
...
{
  Serial.begin(115200);
  Serial.println("one-of-many-152-buoy-2019.ino" );
  Serial.println("Use with ocu-multi.py" );
  
  // start the Ethernet and UDP:
  Ethernet.begin(mac,ip);
  Udp.begin(localPort);
  Serial.print("Buoy is at ");
